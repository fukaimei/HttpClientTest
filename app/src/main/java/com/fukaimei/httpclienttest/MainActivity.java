package com.fukaimei.httpclienttest;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void accessSecret(View v) {
        ...
        new Thread() {
            ...
            public void run() {
                // 创建一个HttpGet对象
                HttpGet get = new HttpGet("http://172.xx.xx.xxx:8080/fukaimei/secret.jsp");  // ①
                try {
                    // 发送GET请求
    ...
    public void showLogin(View v) {
        ...
        // 使用对话框供用户登录系统
        new AlertDialog.Builder(MainActivity.this).setTitle("登录系统").setView(loginDialog)
                .setPositiveButton("登录", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        new Thread() {
                            ...
                            public void run() {
                                try {
                                    HttpPost post = new HttpPost("http://172.xx.xx.xxx:8080/fukaimei/login.jsp"); //③
